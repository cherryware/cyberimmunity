...
CURRENT_TRESHHOLD = 50
TEMPERATURE_TRESHHOLD = 95
    ...
    for sample in data:
        if "param_name" in sample:
            if sample["param_name"] == "current":
                ...
                if current > CURRENT_TRESHHOLD:
                    details["alerts"].append(
                        {
                        "source_id": details["id"],
                        "event": "overload",
                        "current_value": current,
                        "current_threshold": CURRENT_TRESHHOLD
                        }
                    )
                ...
                if temperature > TEMPERATURE_TRESHHOLD:
                    details["alerts"].append(
                        ...
                        "temperature_threshold": TEMPERATURE_TRESHHOLD
                        }
                    )
